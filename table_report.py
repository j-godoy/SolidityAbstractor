...
def get_latex_table():
    ...
    nombre_archivo_k4 = 'B1_k4.csv'
    nombre_archivo_k8 = 'B1_k8.csv'
    nombre_archivo_k16 = 'B1_k16.csv'
    ...
    transitions_states = []
    home = expanduser("~")
    repo_path = os.path.join(home, "Repos","SolidityAbstractor", "graph")
    ...
    for row in file_k4.values:
        ...
        #temporal, quiero ver txs y states
        txs = load_dot_file(path_subject_k8, False, False)[2]
        sts = load_dot_file(path_subject_k8, False)[3] - 1 # resto uno por tener estado Init
        transitions_states.append([subject, sts, txs])
    ...
    print("Transitions and states:")
    print("subject, states, transitions")
    for ts in transitions_states:
        print(ts)
